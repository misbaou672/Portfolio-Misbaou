...
const STEPS: Step[] = [
  {
    id: 'ratp',
    role: 'Stagiaire chargé des réseaux et services informatiques',
    company: 'RATP — DSP 49',
    period: 'Avril – Juin 2026',
    location: 'Lagny / Lilas / Belliard, Île-de-France',
    lines: [
      ...
      'Gestion du parc et des postes de travail : déploiement des mises à jour Windows et des correctifs de sécurité, installation et paramétrage logiciel, préparation des tablettes et téléphones, diagnostic et remplacement du matériel.',
