    ...
    <div ref={rootRef} className={styles.heroContainer}>
      <div className={styles.contentLeft}>
        <div className={styles.badge} data-rise>
          ...
          À la recherche d'une alternance — Île-de-France
        </div>
        ...
        <p className={styles.bio} data-rise>
          Étudiant à l'UPEC et ancien stagiaire à la DSI RATP, j'aime développer des applications web et automatiser des tâches pour simplifier les processus.
        </p>

        <div className={styles.actions} data-rise>
          <a href="#section-projects" className={styles.btnPrimary}>Découvrir mes projets</a>
          <a href="#section-contact" className={styles.btnSecondary}>Me contacter</a>
        </div>
